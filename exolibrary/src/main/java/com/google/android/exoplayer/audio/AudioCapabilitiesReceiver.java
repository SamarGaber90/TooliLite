...
public final class AudioCapabilitiesReceiver {
    ...
    private static AudioCapabilitiesReceiver mInstance;
     ...
     */
    private AudioCapabilitiesReceiver(Context context, Listener listener) {
        this.context = Assertions.checkNotNull(context);
        this.listener = Assertions.checkNotNull(listener);
        this.receiver = Util.SDK_INT >= 21 ? new HdmiAudioPlugBroadcastReceiver() : null;
    }

    public static AudioCapabilitiesReceiver getInstance(Context context, Listener listener) {
        if (mInstance == null)
            mInstance = new AudioCapabilitiesReceiver(context, listener);
